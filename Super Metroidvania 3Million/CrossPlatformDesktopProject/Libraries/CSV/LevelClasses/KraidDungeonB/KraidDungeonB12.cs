...
namespace SuperMetroidvania5Million.Libraries.CSV
{
    ...
    class KraidDungeonB12 : IStageState
    {
        ...
        {
            LoadCsv.Instance.Load("KraidDungeonB16.csv", new Vector2(372, 192), game);
        ...
        {
            LoadCsv.Instance.Load("KraidDungeonB11.csv", new Vector2(792, 192), game);
        ...
        {
            LoadCsv.Instance.Load("KraidDungeonB19.csv", new Vector2(792, 192), game);
