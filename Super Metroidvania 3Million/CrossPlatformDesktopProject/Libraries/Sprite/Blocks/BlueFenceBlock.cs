...
namespace CrossPlatformDesktopProject.Libraries.Sprite.Blocks
{
    class BlueFenceBlock : IBlock
    {
        ...
        public BlueFenceBlock(Vector2 initialLocation, bool isMovingRight)
        {
            this.initialLocation = initialLocation;
            Location = initialLocation;
            Space = new Rectangle((int)Location.X, (int)Location.Y, 32, 32);
            sprite = BlockSpriteFactory.Instance.CreateBlueFenceBlockSprite(this);
